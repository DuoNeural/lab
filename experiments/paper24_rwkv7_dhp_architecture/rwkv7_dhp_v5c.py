"""
RWKV-7 DHP v5c — Learned Temporal Diversity via Delta Rule
==========================================================
...
print(f"\n{'='*70}", flush=True)
print(f"RWKV-7 DHP v5c — {datetime.now().isoformat()}", flush=True)
...
print(f"\n\n{'='*70}", flush=True)
print(f"RWKV-7 DHP v5c — COMPARATIVE SUMMARY", flush=True)
print(f"{'='*70}", flush=True)
...
out_path = HERE / "rwkv7_dhp_v5c.json"
