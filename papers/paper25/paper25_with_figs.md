...
![Figure 4: Dual-probe DHP summary. Left: all DHP confirmations across substrates. Right: both quantum probes (0.750 and 0.766) bracketing the classical 0.72 target in the DHP window [0.65, 0.79].](figs/png/fig4_dhp_synthesis.png)
