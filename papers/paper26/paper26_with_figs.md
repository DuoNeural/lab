...
![Fig 1: Circuit Diagram — Three Noise Conditions](figures/fig1_circuit.png)

**Fig 2** `fig2_v3d_tau.pdf`

![Fig 2: Noiseless v3d Results — Non-Monotonic τ_Liouville](figures/fig2_v3d_tau.png)

**Fig 3** `fig3_v3e_null.pdf`

![Fig 3: Scratch-Qubit Null Result — v3e Identical to Noiseless](figures/fig3_v3e_null.png)

**Fig 4** `fig4_quantum_advantage.pdf`

![Fig 4: Quantum Advantage over Classical DHP Bound](figures/fig4_quantum_advantage.png)

**Fig 5** `fig5_parity_trap.pdf`

![Fig 5: Asymptotic Immunity — T=3 and T=5 Convergence](figures/fig5_parity_trap.png)

**Fig 6** `fig6_theory.pdf`

![Fig 6: Theoretical Framework — Sign-Preservation and Directional Consensus](figures/fig6_theory.png)

**Fig 7** `fig7_qpu_results.pdf`

![Fig 7: Physical QPU Validation — Raw vs. Readout-Mitigated P(q3=1), 4096 Shots](figures/fig7_qpu_results.png)

**Fig 8** `fig8_noise_regularization.pdf`

![Fig 8: Noise-Induced Landscape Regularization — T=5 Convergence vs. Noise Level](figures/fig8_noise_regularization.png)
